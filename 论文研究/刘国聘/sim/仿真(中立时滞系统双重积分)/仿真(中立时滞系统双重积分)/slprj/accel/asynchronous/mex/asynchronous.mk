...
MODEL                = asynchronous
MODULES              = asynchronous_acc.c asynchronous_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/asynchronous_acc.mexw64
MAKEFILE             = asynchronous.mk
MATLAB_ROOT          = D:/matlab
ALT_MATLAB_ROOT      = D:/matlab
START_DIR            = D:/document/论文研究/刘国聘/sim/仿真(中立时滞系统双重积分)/仿真(中立时滞系统双重积分)
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 2
...
MODELLIB                  = asynchronous_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = asynchronous_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/asynchronous \
...
asynchronous_acc.obj : $(START_DIR)/slprj/accel/asynchronous/asynchronous_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/asynchronous/asynchronous_acc.c

asynchronous_acc_data.obj : $(START_DIR)/slprj/accel/asynchronous/asynchronous_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/asynchronous/asynchronous_acc_data.c

rtGetInf.obj : $(START_DIR)/slprj/accel/asynchronous/rtGetInf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/asynchronous/rtGetInf.c

rtGetNaN.obj : $(START_DIR)/slprj/accel/asynchronous/rtGetNaN.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/asynchronous/rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)/slprj/accel/asynchronous/rt_nonfinite.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/asynchronous/rt_nonfinite.c

#ifndef RTW_HEADER_asynchronous_acc_private_h_
#define RTW_HEADER_asynchronous_acc_private_h_
#include "rtwtypes.h"
...
int_T * maxNewBufSzPtr ) ; real_T asynchronous_acc_rt_TDelayInterpolate (
